...
# 
# **Answer**:The two question that can be answered using data for bike is : (1) How many bikes used in one hour. (2) Which city uses the maximum number of bikes in a month. (3) How many bikes used in a month by all three cities.etc.
# 
...
# 
# **Answer**:  The city having highest number of trips is NYC. ii)The city having highest proportion of trips made by subscribers is NYC. iii)The city having highest proportion of trips for short-term customers is Chicago.
...
# 
# **Answer**:  The average length of trip for Washington is 18.The Proportion of long rides is : 10.8 The average leength of trip  for NYC is 15.The Proportion of long rides is 7.3 The average length of trip for Chicago is 16. The Proportion of long rides is is 8.3
...
def mean_trip_length(filename):
    with open(filename, 'r') as f_i:
        rd = csv.DictReader(f_i)
...
data_file_Washington = './data/Washington-2016-Summary.csv'
av = mean_trip_length(data_file_Washington)
print("mean trip length Washington: {}, Prop of long rides: {}".format(av[0], av[1]))

data_file_NYC = './data/NYC-2016-Summary.csv'
av = mean_trip_length(data_file_NYC)
print("mean trip length NYC: {}, Prop of long rides: {}".format(av[0], av[1]))

data_file_Chicago = './data/Chicago-2016-Summary.csv'
av = mean_trip_length(data_file_Chicago)
print("mean trip length Chicago: {}, Prop of long rides : {}".format(av[0], av[1]))


# **Question 4c**: Dig deeper into the question of trip duration based on ridership. Choose one city. Within that city, which type of user takes longer rides on average: Subscribers or Customers?
# 
# **Answer**: The Washington city is selected because the avg trip duration of customer is 41.7. avg trip duration of subscribers is 12.5 therefore, customers takes much long rides in average in washington city.
...
av = many_dur(data_file_NYC)
print("The City Selected is  Washington, Average trip duration for Subscribers: {} ; Average trip duration for Customers: {} ".format(av[0], av[1]))
...
# 
# **Answer**: the peak value lies betwen the interval 15-20 for customers and 5-10 for subscribers . the graphical chart represents dense at on side so it is right skewed distribution.
...
# 
# **Answer**: The data can be used to explore the understandings of trips made by customers on the weekdays and weekend by visualizing the data.
...
# 
# **Answer**: Data science is so useful in our daily lifes. With the help of data science everything is connected by datas,by the help of this differnt predictions  and expectations of the data can be made and we can further analyse the data which can be used in organizations, weather forecasting etc to predict the weather and provide the results regarding it.By choosing this subject i would like to study more about deep learning and do an advanced courses on datascience.
# 
